...
class MatcherTests extends FlatSpec {
  "Matcher test is passed a file matching the filter" should
  ...
  "Matches given a path that has one file that matches file filter and content filter" should
  "return a list with that file name" in {
  ...
  "Matches given a path that has no file that matches file filter and content filter" should
